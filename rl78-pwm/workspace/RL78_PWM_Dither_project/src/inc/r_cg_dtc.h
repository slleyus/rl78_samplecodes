...
#define _FF34_DTCD0_DEST_ADDRESS            (0xFF34U)      /* DAC0 address */
#define _FF1A_DTCD0_DEST_ADDRESS            (0xFF1AU)      /* TDR01 TO01 pwm compare address is FF1A*/
#define _10_DTCD0_TRANSFER_BYTE             (0x10U)
