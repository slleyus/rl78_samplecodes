...
Macro definitions
***********************************************************************************************************************/
#define _CE00_UART1_RECEIVE_DIVISOR      (0xCE00U)	/*divide by 208 (for 2.4K, 4.8K, 9.6K, 19.2K, 38.4K 76.8K, 153.6Kbaud at fIH = 32MHZ) */
#define _CE00_UART1_TRANSMIT_DIVISOR     (0xCE00U)	/*divide by 208 (for 2.4K, 4.8K, 9.6K, 19.2K, 38.4K 76.8K, 153.6Kbaud at fIH = 32MHZ) */
#define _8800_UART1_RECEIVE_DIVISOR      (0x8800U)	/*divide by 138 (for 14.4K, 28.8K, 57.6K 115.2Kbaud at fIH = 32MHZ) */
#define _8800_UART1_TRANSMIT_DIVISOR     (0x8800U)	/*divide by 138 (for 14.4K, 28.8K, 57.6K 115.2Kbaud at fIH = 32MHZ) */
