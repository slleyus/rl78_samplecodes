...
;*******************************************************************************
;*******************************************************************************
;* File Name  : stl_RL78_march_c_initial.asm
;* Version    : 2.00
;* Device(s)  : RL78/G14
;* Tool-Chain : RL78 CS+ V3.03.00
;* OS         : None
;* H/W Platform : RL78/G14 Target Board
;* Description : RL78 IEC Self Test Library March C test initial assembler module
...
;       start address, stop, range, step indicator values of march_c test
;*
;*     Register "A" returns 0x01 if a memory fault was detected, otherwise
;*     0x00 is returned
;*
;* Limitations : The march_c_initial is a destructive RAM test
...
;*******************************************************************************
    ...
    .PUBLIC  _stl_RL78_march_c_initial

    .EXTERN  _stl_RL78_march_c_initial_finish

	.CSEG


;******************************************************************************
;* Outline : stl_RL78_march_c_initial Initial RL78 IEC March_c test module
;* Include : none
;* Declaration : stl_RL78_march_c_initial:
;* Function Name: stl_RL78_march_c_initial
;* Description : Initial IEC March_c test code module
...
;******************************************************************************
; start of initial march_c module
_stl_RL78_march_c_initial:
...
;* test if length is zero
        ...
        br    !!_stl_RL78_march_c_initial_finish

;* start march -c test
length_not_zero:
        MOVW  AX, 0xFFEF0       ; store start address of march c test into AX
...
;* init step 1
        MOVW  HL, 0xFFEF0       ; march-c start address from BC [Bank1] into HL register
...
;* init step 4
march_c_step_4:
        MOVW  AX, 0xFFEF0       ; march-c start address from BC [Bank1] into AX register
...
ret_step_4:
        MOVW  AX, 0xFFEF0       ; march-c start address from BC [Bank1] into HL register
        CMPW  AX, HL            ; check if all specified memory is written one to
